...
We now have the tools we need to run a job. This is a very
...
Create the following file to simulate a "monkey":
```
#!/usr/bin/env python3
...
problem. The monkeys don't need to know anything about what the other monkeys
are doing.

By making the following modification to our submission script (`monkey-job.sh`),
we can put an array of monkeys to work!
